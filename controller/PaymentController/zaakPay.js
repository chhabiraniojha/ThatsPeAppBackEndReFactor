...
exports.webhook = async (req, res) => {
    ...
    try {
        ...
        const isValidChecksum = zaakpayChecksum.validateZaakpayWebhookChecksum(
            txnData,
            checksum
        );
        ...
        const { purpose, orderId:paymentOrderId, walletOrderId } = paymentRecord;
        const finalOrderId = purpose === 'addfund' ? walletOrderId : paymentOrderId;
